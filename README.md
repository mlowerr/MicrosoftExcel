...
- **Timeline_Template.xlsx** — Excel template for quick Gantt chart style visualization of project schedule.  Flexibility to include additional callouts such as deliverables for phase/work package.  Most formatting driven through conditional formatting.  Also useful to quickly create a 'base' for a PowerPoint.
